...
class BaseModel:
    """
    BaseModel class serves as the base class for all other models in the project.
    It defines common attributes and methods that are inherited by other classes.

    Attributes:
        id (str): Unique identifier for the instance.
        created_at (datetime.datetime): DateTime object representing the creation timestamp.
        updated_at (datetime.datetime): DateTime object representing the last update timestamp.
